...
任务适配性不是二元判断，而是一个光谱。强适配意味着 LLM 具有结构性优势，其他方案无法在合理成本内达到同等效果。中等适配意味着 LLM 可用，但传统方案也能胜任，选择取决于工程权衡。弱适配意味着 LLM 勉强能做，但替代方案更简单、更可靠、更经济。不适配意味着任务的核心需求落在 LLM 的能力边界之外，强行使用只会制造复杂性。
